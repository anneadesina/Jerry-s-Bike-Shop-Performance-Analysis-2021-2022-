# Jerry-s-Bike-Shop-Performance-Analysis-2021-2022-
This report analyzes the performance of Jerry’s Bike Shop between 2021 and 2022, focusing on revenue trends, profit generation, rider activity, seasonal performance, and customer demographics. It explains how operational data was analyzed and visualized using dashboard tools to support data-driven business decisions.

sing SQL for data extraction and transformation and Power BI for interactive dashboards, the dataset was converted into meaningful insights that reveal when the business earns the most, who its most valuable customers are, and how demand evolves over time.
